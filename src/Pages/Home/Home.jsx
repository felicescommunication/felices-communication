...
function SectionFallback() {
  // Rien à faire ici : le MutationObserver déjà mis en place par
  // useScrollAnimation() dans Home() détecte automatiquement les nouvelles
  // sections .animate-section quand elles apparaissent (ex: après un lazy load).
  return (
