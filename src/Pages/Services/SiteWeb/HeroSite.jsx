...
export default function HeroSiteWeb({ sectionRef }) {
  useScrollAnimation();
  ...
  return (
    <div className="relative isolate min-h-[70vh] lg:min-h-screen pt-28 pb-32 lg:pb-4 z-10">
      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h2 className="font-['TitanOne'] text-[50px] md:text-7xl lg:text-[70px] text-[#54001A] mb-8">
              Site web
            </h2>
            ...
            <div className="lg:hidden relative w-[320px] h-[310px]">
              {[
                { src: "/images/siteweb/point.webp", delay: "0.1s" },
                { src: "/images/siteweb/siteweb-layer1.webp", delay: "0.2s" },
                { src: "/images/siteweb/siteweb-layer2.webp", delay: "0.3s" },
                { src: "/images/siteweb/siteweb-layer3.webp", delay: "0.4s" }
              ].map((img, i) => (
                <img
                  key={i}
                  src={img.src}
            ...
            <p className="text-lg md:text-xl text-[#021d36] mt-10 lg:mt-0">
              Un site web à l’image de votre marque, <br />optimisé pour convertir
            </p>
          ...
          <div className="hidden lg:flex justify-end items-center">
            <Suspense fallback={<div style={{ width: 460, height: 370 }} />}>
              <ImageParallax
                ...
                height={370}
                layers={[
                  { src: "/images/siteweb/point.webp", speed: 1 },
                  { src: "/images/siteweb/siteweb-layer1.webp", speed: 2 },
                  { src: "/images/siteweb/siteweb-layer2.webp", speed: 3 },
                  { src: "/images/siteweb/siteweb-layer3.webp", speed: 4 }
                ]}
              />
            </Suspense>
          </div>
      ...
      {/* background text */}
      <div className="absolute -bottom-2 w-full overflow-hidden pointer-events-none">
        <ScrollVelocity
          texts={["Site web"]}
          velocity={60}
