const projets = [
...

  {
    ...
    cover: "/images/projets/grand-blanc/grand-blanc.jpg",
    ...
    // ✅ GALLERY AVEC TYPES
    gallery: [
      { type: "image", src: "/images/projets/grand-blanc/demo.mp4" }
      // { type: "video", src: "/videos/demo.mp4" } 👈 possible
    ],

    bottomGallery: [
      { type: "image", src: "/images/projets/grand-blanc/machine.jpg" },
      { type: "image", src: "/images/projets/grand-blanc/chiffon.jpg" },
      { type: "image", src: "/images/projets/grand-blanc/porte-cles.jpg" }
    ],
    ...
    sections: [
      {
        ...
        images: [
          { type: "image", src: "/images/projets/grand-blanc/Photo-logo.jpg" },
          { type: "image", src: "/images/projets/grand-blanc/carte-visite-grand-blanc.jpg" },
          { type: "image", src: "/images/projets/grand-blanc/depliant-grand-blanc.jpg" }
        ]
      },
      {
        text1:
        ...
        images: [
          { type: "image", src: "/images/projets/grand-blanc/granier.jpg" },
          { type: "image", src: "/images/projets/grand-blanc/camion.jpg" },
          { type: "image", src: "/images/projets/grand-blanc/réseaux-sociaux.jpg" }
        ]
      }
    ]
  }
